...
# hyper parameters
dic_size = len(char2idx)  #14 RNN input size (one hot size)
hidden_size = len(char2idx)  # abs(characters in sample) RNN output size
...
# FC layer
X_for_fc = tf.reshape(outputs, [-1, hidden_size]) # full connected
